...
CREATE INDEX idx_booksy_sync_logs_salon_id ON booksy_sync_logs(salon_id);
CREATE INDEX idx_booksy_sync_logs_started ON booksy_sync_logs(started_at DESC);
CREATE INDEX idx_booksy_sync_logs_triggered ON booksy_sync_logs(triggered_by);
