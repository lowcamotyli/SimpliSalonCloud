...
CREATE INDEX IF NOT EXISTS idx_form_templates_salon_id ON public.form_templates(salon_id);
...
CREATE INDEX IF NOT EXISTS idx_client_forms_client_id ON public.client_forms(client_id);
CREATE INDEX IF NOT EXISTS idx_client_forms_booking_id ON public.client_forms(booking_id);
CREATE INDEX IF NOT EXISTS idx_client_forms_fill_token ON public.client_forms(fill_token) WHERE fill_token IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_beauty_plans_client_id ON public.beauty_plans(client_id);
...
CREATE INDEX IF NOT EXISTS idx_beauty_plan_steps_plan_id ON public.beauty_plan_steps(plan_id);
...
DROP POLICY IF EXISTS "service_forms_select" ON public.service_forms;
...
DROP POLICY IF EXISTS "service_forms_write" ON public.service_forms;
