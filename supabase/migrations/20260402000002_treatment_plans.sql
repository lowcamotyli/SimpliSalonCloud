...
-- Create Indexes
CREATE INDEX ix_treatment_plans_salon_client ON public.treatment_plans (salon_id, client_id);
CREATE INDEX ix_treatment_sessions_plan_id ON public.treatment_sessions (plan_id);
CREATE INDEX ix_treatment_sessions_salon_booking ON public.treatment_sessions (salon_id, booking_id);
