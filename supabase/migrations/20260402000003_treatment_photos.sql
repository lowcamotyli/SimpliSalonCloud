...
CREATE INDEX ix_treatment_photos_treatment_record_id ON public.treatment_photos(treatment_record_id);
CREATE INDEX ix_treatment_photos_salon_id_client_id ON public.treatment_photos(salon_id, client_id);
