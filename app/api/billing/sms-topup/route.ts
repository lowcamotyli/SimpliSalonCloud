...
export async function POST(request: NextRequest) {
  try {
    ...
    // invoice_number is auto-generated by DB trigger — cast to bypass required field check
    ...
    logger.error('billing.sms-topup failed', error, { endpoint: 'POST /api/billing/sms-topup' })
