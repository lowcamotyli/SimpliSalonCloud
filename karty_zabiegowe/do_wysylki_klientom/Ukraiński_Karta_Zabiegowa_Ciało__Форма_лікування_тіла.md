# Ukraiński: Karta Zabiegowa Ciało / Форма лікування тіла

Zweryfikuj zawartość karty zabiegowej dla zabiegu Ukraiński: Karta Zabiegowa Ciało / Форма лікування тіла
...
Рубці
Целюліт
ДряблістьМ’язові напруження
Розтяжки
Пігментація
Чи здійснюєте ви догляд за тілом?
Так
Намагаюсь
Ні
Якщо так, вкажіть, якщо ні, введіть «X».
...
01–2 рази на тиждень3–4 рази на тиждень
...
Біотин
Колаген
Не приймаю добавокІНШЕ – ВКАЖІТЬ НИЖЧЕ
Якщо приймаєте інші, ніж зазначено вище, вкажіть: якщо ні – напишіть «X».
Позначте всі відповіді, які стосуються вашого харчування:
...
Раціон бідний на фрукти та овочі
...
Місце для додаткової інформації/нотаток (якщо немає, напишіть «X»):
