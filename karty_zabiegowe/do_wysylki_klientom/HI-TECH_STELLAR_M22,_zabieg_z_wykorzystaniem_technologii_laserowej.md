# HI-TECH: STELLAR M22, zabieg z wykorzystaniem technologii laserowej

Zweryfikuj zawartość karty zabiegowej dla zabiegu HI-TECH: STELLAR M22, zabieg z wykorzystaniem technologii laserowej
...
obrzękipokrzywkaswędzenieznamiona barwnikoweżadne z powyższych
Czy występowały kiedykolwiek u Pana(i) zaburzenia hormonalne?
Tak    Nie
Czy choruje lub chorował(a) Pan(i) na którąś z następujących chorób?
choroby nowotworowechoroby układu krążenia (nadciśnienie, niskie ciśnienie, omdlenia)choroby naczyń krwionośnych (żylaki, zapalenie żył, złe ukrwienie kończyn)zaburzenia metaboliczne (np. cukrzyca)choroby układu nerwowego (padaczka, zaburzenia czucia, niedowłady, utraty przytomności, porażenia, miastenia)choroby psychosomatyczne (depresja, nerwica)choroby zakaźne (żółtaczka, WZW, AIDS/HIV, HPV, choroby weneryczne)choroby skóry (łuszczyca, bielactwo, AZS, fotodermatozy)opryszczkażadne z powyższych
Czy choruje lub chorował(a) Pan(i) na inne dolegliwości?
Tak    Nie
Jeśli tak, to na jakie?
Czy zażywa Pan(i) leki przeciwbólowe (ibuprofen, ketoprofen, naproksen)?
Tak    Nie
Jeśli tak, to kiedy i ile?
Czy pił(a) Pan(i) alkohol w ciągu ostatnich 24 godzin?
Tak    Nie
Czy zażywa Pan(i) środki uspakajające, nasenne, narkotyki?
Tak    Nie
Jeśli tak, to jakie?
Czy przyjmował(a) Pan(i) tetracykliny lub izotretynoinę (Accutane, Izotek)?
Tak    Nie
Jeśli tak, to kiedy?
...
Tak    Nie
Data ostatniej ekspozycji na słońce:
Czy używa Pan(i) samoopalaczy?
Tak    Nie
...
Tak    Nie
Jeśli tak, to jakie?
Czy w ciągu ostatnich 3 miesięcy miał(a) Pan(i) wykonywany kontrast?
Tak    Nie
Czy w ciągu ostatnich 3 miesięcy poddał(a) się Pan(i) znieczuleniu ogólnemu?
Tak    Nie
...
Nie
Nie dotyczy
Wyrażam świadomą i dobrowolną zgodę na wykonanie zabiegu:
Zostałem(am) wyczerpująco poinformowany(a) o: przeciwwskazaniach do wykonania zabiegu; technice i metodzie przeprowadzenia zabiegu; pochodzeniu i sposobie działania preparatów i urządzeń, które zostaną użyte do wykonania zabiegu; objawach jakie mogą wystąpić podczas i po zabiegu; przewidywanym okresie utrzymywania się rezultatów zabiegu; średniej ilości zabiegów, której wykonanie niezbędne jest do osiągnięcia i utrzymania efektów.
Zostałem(am) poinformowany(a), że ilość zabiegów oraz ich efekty nie są identyczne dla każdego pacjenta i że uzależnione są od osobniczych cech.
Zostałem(am) poinformowany(a), że notuje się indywidualne przypadki, w których osiągnięcie oczekiwanych efektów zabiegu jest niemożliwe oraz przyjmuję to ryzyko.
Udzielono mi wyczerpującej informacji na temat wszelkich możliwych do przewidzenia następstw i powikłań, jakie mogą wystąpić w związku z zabiegiem. Miałem możliwość zadawania pytań i uzyskałem na nie odpowiedzi. Powyższe ryzyko zabiegowe przyjmuję i nie będę z tego tytułu zgłaszać jakichkolwiek roszczeń.
Zostały mi przekazane zalecenia i wskazówki pielęgnacyjne do stosowania po wykonaniu zabiegu, zapoznałem(am) się z nimi i zobowiązuję się ich przestrzegać.
Wyrażam zgodę na wykonanie dokumentacji fotograficznej w celu załączenia do karty pacjenta.
W razie wystąpienia niepokojących mnie objawów skontaktuję się ze specjalistą wykonującym zabieg.
Jestem świadomy(a), że rozbieżność pomiędzy oczekiwanym przeze mnie efektem zabiegu a jego rzeczywistym efektem, mieszczącym się w granicach skali, o której zostałem uprzedzony, nie może być podstawą do roszczeń odszkodowawczych. Zobowiązuję się do powiadomienia osoby wykonującej zabiegi w serii zabiegowej o każdej zaistniałej zmianie, która dotyczy mojego stanu zdrowia. Zostałam/em poinformowana, że każdorazowo wypełniam kwestionariusz zgody na zabieg.
Oświadczam że, zapoznałam(em) się z powyższym tekstem i wyrażam świadomą zgodę na wykonie zabiegu
Tak    Nie
